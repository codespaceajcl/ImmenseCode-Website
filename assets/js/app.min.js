...
! function(e, t) {
                        ...
                        return function n(s) {
                            for (var r = e.querySelectorAll(t), o = s.target; o && o !== this; o = o.parentNode)
                                for (var a = r.length; a--;)
                                    if (r[a] === o) return s.delegateTarget = o, n.oneOff && H.off(e, s.type, i), i.apply(o, [s]);
                            return null
                        }
                    }(e, i, n) : function(e, t) {
                        return function i(n) {
    ...
    H.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', W.handleDismiss(new W)), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[B];
    ...
    var Y = {
        ...
        Q = function(e) {
            ...
            return r.next = function() {
                ...
                e.prototype.dispose.call(this), H.off(this._element, ".bs.carousel"), this._items = null, this._config = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                $.find(".carousel-item img", this._element).forEach((function(e) {
                ...
                var i = this._getItemIndex(e),
                    n = this._getItemIndex($.findOne(".active.carousel-item", this._element));
                ...
                if (this._indicatorsElement) {
                    for (var t = $.find(".active", this._indicatorsElement), i = 0; i < t.length; i++) t[i].classList.remove("active");
                    var n = this._indicatorsElement.children[this._getItemIndex(e)];
                    n && n.classList.add("active")
                }
            }, r._updateInterval = function() {
                var e = this._activeElement || $.findOne(".active.carousel-item", this._element);
                if (e) {
                ...
                if ("next" === e ? (i = "carousel-item-start", n = "carousel-item-next", s = "left") : (i = "carousel-item-end", n = "carousel-item-prev", s = "right"), l && l.classList.contains("active")) this._isSliding = !1;
                    ...
                    } else o.classList.remove("active"), l.classList.add("active"), this._isSliding = !1, H.trigger(this._element, "slid.bs.carousel", {
                        relatedTarget: l,
                        direction: s,
                        from: a,
                        to: c
    ...
    H.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Q.dataApiClickHandler), H.on(window, "load.bs.carousel.data-api", (function() {
        for (var e = $.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++) Q.carouselInterface(e[t], x(e[t], "bs.carousel"))
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[G];
    ...
    var K = "collapse",
        ...
        ee = function(e) {
            function s(t, i) {
                var n;
                (n = e.call(this, t) || this)._isTransitioning = !1, n._config = n._getConfig(i), n._triggerArray = $.find('[data-bs-toggle="collapse"][href="#' + t.id + '"],[data-bs-toggle="collapse"][data-bs-target="#' + t.id + '"]');
                for (var s = $.find('[data-bs-toggle="collapse"]'), r = 0, o = s.length; r < o; r++) {
                    var a = s[r],
                        c = l(a),
            ...
            return r.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    var t, i;
                    this._parent && 0 === (t = $.find(".show, .collapsing", this._parent).filter((function(t) {
                    ...
                    if (!H.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        ...
                        H.one(this._element, "transitionend", (function() {
                            e._element.classList.remove("collapsing"), e._element.classList.add("collapse", "show"), e._element.style[o] = "", e.setTransitioning(!1), H.trigger(e._element, "shown.bs.collapse")
                ...
                p(t) ? void 0 === t.jquery && void 0 === t[0] || (t = t[0]) : t = $.findOne(t);
                var i = '[data-bs-toggle="collapse"][data-bs-parent="' + t + '"]';
                return $.find(i, t).forEach((function(t) {
                    var i = c(t);
    ...
    function Re(e, t) {
        void 0 === t && (t = []);
        var i = function e(t) {
                return ["html", "body", "#document"].indexOf(ce(t)) >= 0 ? t.ownerDocument.body : pe(t) && We(t) ? t : e(we(t))
            }(e),
            n = "body" === ce(i),
            s = de(i),
        ...
        fn: function(e) {
            ...
            if (!t.modifiersData[n]._skip) {
                for (var s = i.mainAxis, r = void 0 === s || s, o = i.altAxis, a = void 0 === o || o, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, p = i.altBoundary, f = i.flipVariations, h = void 0 === f || f, m = i.allowedAutoPlacements, g = t.options.placement, v = he(g), y = l || (v !== g && h ? function(e) {
                    ...
                    var P = ze(O),
                        z = [];
                    if (r && z.push(A[M] <= 0), a && z.push(A[O] <= 0, A[P] <= 0), z.every((function(e) {
                            return e
                        }))) {
                        S = C, x = !1;
                        break
                ...
                if (_) {
                    if (r) {
                        var M = "y" === w ? te : se,
                            ...
                            $ = Y ? "y" === w ? Y.clientTop || 0 : Y.clientLeft || 0 : 0,
                            G = t.modifiersData.offset ? t.modifiersData.offset[t.placement][w] : 0,
                            X = _[w] + q - G - $,
                            V = _[w] + F - G,
                            U = Se(f ? Math.min(A, X) : A, k, f ? Math.max(O, V) : O);
                        _[w] = U, C[w] = U - k
                    }
                    if (a) {
                        var Q = "x" === w ? te : se,
    ...
    function et(e, t, i) {
        ...
        return (a || !a && !i) && (("body" !== ce(t) || We(r)) && (l = (n = t) !== de(n) && pe(n) ? {
            scrollLeft: (s = n).scrollLeft,
            scrollTop: s.scrollTop
        } : Ne(n)), pe(t) ? ((c = He(t)).x += t.clientLeft, c.y += t.clientTop) : r && (c.x = Be(r))), {
    ...
    var st = nt(),
        rt = nt({
            defaultModifiers: [Oe, Ze, ke, fe]
        }),
        ot = nt({
            defaultModifiers: [Oe, Ze, ke, fe, Ke, Xe, Je, Me, Qe]
        }),
        at = Object.freeze({
            __proto__: null,
            popperGenerator: nt,
            ...
            return r.toggle = function() {
                ...
                if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                    ...
                    if (!H.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                        ...
                        })), this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), H.trigger(e, "shown.bs.dropdown", t)
                    }
                }
            }, r.hide = function() {
                if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
                    ...
                    H.trigger(e, "hide.bs.dropdown", t).defaultPrevented || (this._popper && this._popper.destroy(), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), H.trigger(e, "hidden.bs.dropdown", t))
                }
            }, r.dispose = function() {
                e.prototype.dispose.call(this), H.off(this._element, ".bs.dropdown"), this._menu = null, this._popper && (this._popper.destroy(), this._popper = null)
            }, r.update = function() {
                ...
                return e = i({}, this.constructor.Default, Y.getDataAttributes(this._element), e), h(lt, e, this.constructor.DefaultType), e
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                    for (var t = $.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                        ...
                        if (e && "click" === e.type && (a.clickEvent = e), o) {
                            var l, c = o._menu;
                            if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && c.contains(e.target) || H.trigger(r, "hide.bs.dropdown", a).defaultPrevented)) "ontouchstart" in document.documentElement && (l = []).concat.apply(l, document.body.children).forEach((function(e) {
                                return H.off(e, "mouseover", null, (function() {}))
                            })), t[i].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), c.classList.remove("show"), t[i].classList.remove("show"), H.trigger(r, "hidden.bs.dropdown", a)
                        }
                    }
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !ct.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                    ...
                    if ("Escape" === e.key) return (this.matches('[data-bs-toggle="dropdown"]') ? this : $.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void s.clearMenus();
                    if (i && "Space" !== e.key) {
                        var n = $.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(m);
                        if (n.length) {
    ...
    H.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', yt.dataApiKeydownHandler), H.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", yt.dataApiKeydownHandler), H.on(document, "click.bs.dropdown.data-api", yt.clearMenus), H.on(document, "keyup.bs.dropdown.data-api", yt.clearMenus), H.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', (function(e) {
    ...
    var bt = {
        ...
        Et = function(e) {
            function s(t, i) {
                var n;
                return (n = e.call(this, t) || this)._config = n._getConfig(i), n._dialog = $.findOne(".modal-dialog", t), n._backdrop = null, n._isShown = !1, n._isBodyOverflowing = !1, n._ignoreBackdropClick = !1, n._isTransitioning = !1, n._scrollbarWidth = 0, n
            }
            n(s, e);
            var r = s.prototype;
            return r.toggle = function(e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    this._isShown || i.defaultPrevented || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), H.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', (function(e) {
                        return t.hide(e)
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning && !H.trigger(this._element, "hide.bs.modal").defaultPrevented) {
                    ...
                    if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), H.off(document, "focusin.bs.modal"), this._element.classList.remove("show"), H.off(this._element, "click.dismiss.bs.modal"), H.off(this._dialog, "mousedown.dismiss.bs.modal"), i) {
                ...
                })), e.prototype.dispose.call(this), H.off(document, "focusin.bs.modal"), this._config = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
                ...
                if (i) {
                    ...
                    H.one(this._dialog, "transitionend", s), f(this._dialog, r)
                } else s()
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), document.body.appendChild(this._backdrop), H.on(this._element, "click.dismiss.bs.modal", (function(e) {
                    ...
                    if (this._element.classList.contains("fade")) {
                        ...
                        H.one(this._backdrop, "transitionend", s), f(this._backdrop, r)
                    } else s()
                } else e()
                ...
                if (!H.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented) {
                    ...
                    H.off(this._element, "transitionend"), H.one(this._element, "transitionend", (function() {
                        e._element.classList.remove("modal-static"), t || (H.one(e._element, "transitionend", (function() {
                ...
                if (this._isBodyOverflowing) {
                    $.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(t) {
                ...
                $.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(e) {
    ...
    H.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(e) {
        var t = this,
            n = c(this);
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault(), H.one(n, "show.bs.modal", (function(e) {
            e.defaultPrevented || H.one(n, "hidden.bs.modal", (function() {
                m(t) && t.focus()
            }))
        }));
        var s = x(n, "bs.modal");
        ...
        Pt = function(e) {
            ...
            return r.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    _(s, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || c.appendChild(s), H.trigger(this._element, this.constructor.Event.INSERTED), this._popper = ot(this._element, s, this._getPopperConfig(l)), s.classList.add("show");
                    ...
                    var m = function() {
                        var t = e._hoverState;
                        e._hoverState = null, H.trigger(e._element, e.constructor.Event.SHOWN), "out" === t && e._leave(null, e)
                    };
                ...
                if (this._popper) {
                    var t = this.getTipElement(),
                        i = function() {
                            "show" !== e._hoverState && t.parentNode && t.parentNode.removeChild(t), e._cleanTipClass(), e._element.removeAttribute("aria-describedby"), H.trigger(e._element, e.constructor.Event.HIDDEN), e._popper && (e._popper.destroy(), e._popper = null)
                        };
                ...
                return !1 === this.config.container ? document.body : p(this.config.container) ? this.config.container : $.findOne(this.config.container)
            }, r._getAttachment = function(e) {
                return kt[e.toUpperCase()]
            }, r._setListeners = function() {
                var e = this;
                this.config.trigger.split(" ").forEach((function(t) {
                    if ("click" === t) H.on(e._element, e.constructor.Event.CLICK, e.config.selector, (function(t) {
                        return e.toggle(t)
                    }));
                    else if ("manual" !== t) {
                    ...
                    e._element && e.hide()
                }, H.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = i({}, this.config, {
                    trigger: "manual",
                    selector: ""
                }) : this._fixTitle()
    ...
    var Wt = "scrollspy",
        ...
        Ft = function(e) {
            ...
            return r.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), $.find(this._selector).map((function(e) {
                    var t = l(e),
                        s = t ? $.findOne(t) : null;
                    if (s) {
                ...
                e.prototype.dispose.call(this), H.off(this._scrollElement, ".bs.scrollspy"), this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, r._getConfig = function(e) {
                ...
                var t = this._selector.split(",").map((function(t) {
                    ...
                    i = $.findOne(t.join(","));
                i.classList.contains("dropdown-item") ? ($.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active"), i.classList.add("active")) : (i.classList.add("active"), $.parents(i, ".nav, .list-group").forEach((function(e) {
                    $.prev(e, ".nav-link, .list-group-item").forEach((function(e) {
                        return e.classList.add("active")
                    })), $.prev(e, ".nav-item").forEach((function(e) {
                        $.children(e, ".nav-link").forEach((function(e) {
                            return e.classList.add("active")
                        }))
                    }))
                ...
                $.find(this._selector).filter((function(e) {
    ...
    H.on(window, "load.bs.scrollspy.data-api", (function() {
        ...
        if (e) {
            var t = e.fn[Wt];
            e.fn[Wt] = Ft.jQueryInterface, e.fn[Wt].Constructor = Ft, e.fn[Wt].noConflict = function() {
    ...
    var Yt = function(e) {
        ...
        return s.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                ...
                var r = null;
                if (t && (r = H.trigger(t, "hide.bs.tab", {
                        relatedTarget: this._element
            ...
            var n = this,
                s = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? $.children(t, ".active") : $.find(":scope > li > .active", t))[0],
            ...
            if (s && r) {
                var a = d(s);
                s.classList.remove("show"), H.one(s, "transitionend", o), f(s, a)
            } else o()
        }, s._transitionComplete = function(e, t, i) {
            if (t) {
                t.classList.remove("active");
                var n = $.findOne(":scope > .dropdown-menu .active", t.parentNode);
                n && n.classList.remove("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
            }
            e.classList.add("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), v(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && e.parentNode.classList.contains("dropdown-menu") && (e.closest(".dropdown") && $.find(".dropdown-toggle").forEach((function(e) {
                return e.classList.add("active")
        ...
        Xt = function(e) {
            ...
            return r.show = function() {
                ...
                if (!H.trigger(this._element, "show.bs.toast").defaultPrevented) {
                    ...
                    var t = function() {
                        e._element.classList.remove("showing"), e._element.classList.add("show"), H.trigger(e._element, "shown.bs.toast"), e._config.autohide && (e._timeout = setTimeout((function() {
                            e.hide()
                        }), e._config.delay))
                    };
                ...
                if (this._element.classList.contains("show") && !H.trigger(this._element, "hide.bs.toast").defaultPrevented) {
                    var t = function() {
                        e._element.classList.add("hide"), H.trigger(e._element, "hidden.bs.toast")
                    };
                ...
                this._clearTimeout(), this._element.classList.contains("show") && this._element.classList.remove("show"), H.off(this._element, "click.dismiss.bs.toast"), e.prototype.dispose.call(this), this._config = null
            }, r._getConfig = function(e) {
                return e = i({}, Gt, Y.getDataAttributes(this._element), "object" == typeof e && e ? e : {}), h("toast", e, this.constructor.DefaultType), e
            }, r._setListeners = function() {
                var e = this;
...
function(e) {
    ...
    e.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(A), k = t.st.ajax.cursor, w(a + "." + A, P), w("BeforeChange." + A, P)
            },
            getAjax: function(i) {
                ...
                var n = e.extend({
                    ...
                    success: function(n, s, r) {
                        ...
                        _("ParseAjax", o), t.appendContent(e(o.data), A), i.finished = !0, O(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(h)
...
var Swiper = function() {
        ...
        for (let n = 1; n < arguments.length; n += 1) {
            ...
            if (null != s && (i = s, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                ...
                for (let t = 0, n = i.length; t < n; t += 1) {
                    ...
                    void 0 !== r && r.enumerable && (c(e[n]) && c(s[n]) ? s[n].__swiper__ ? e[n] = s[n] : d(e[n], s[n]) : !c(e[n]) && c(s[n]) ? (e[n] = {}, s[n].__swiper__ ? e[n] = s[n] : d(e[n], s[n])) : e[n] = s[n])
                }
            }
        }
        var i;
    ...
    function M() {
        return S || (S = function() {
            ...
            if (i()) {
                ...
                if (i.includes("Version/index.html")) {
                    const [e, n] = i.split("Version/index.html")[1].split(" ")[0].split(".").map(e => Number(e));
                    t = e < 16 || 16 === e && n < 2
                }
            }
            return {
    ...
    function O(e) {
        ...
        Object.assign(o, {
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), c.startX = v, c.startY = y, o.touchStartTime = a(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, l.threshold > 0 && (o.allowThresholdMove = !1);
        let E = !0;
        p.matches(o.focusableElements) && (E = !1, "SELECT" === p.nodeName && (o.isTouched = !1)), i.activeElement && i.activeElement.matches(o.focusableElements) && i.activeElement !== p && i.activeElement.blur();
        const _ = E && t.allowTouchMove && l.touchStartPreventDefault;
        !l.touchStartForcePreventDefault && !_ || p.isContentEditable || u.preventDefault(), l.freeMode && l.freeMode.enabled && t.freeMode && t.animating && !l.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", u)
    }
    ...
    function P(e) {
        ...
        if (!i.allowTouchMove) return d.target.matches(s.focusableElements) || (i.allowClick = !1), void(s.isTouched && (Object.assign(o, {
            startX: f,
            startY: h,
        ...
        if (r.touchReleaseOnEdges && !r.loop)
            if (i.isVertical()) {
                if (h < o.startY && i.translate <= i.maxTranslate() || h > o.startY && i.translate >= i.minTranslate()) return s.isTouched = !1, void(s.isMoved = !1)
            } else if (f < o.startX && i.translate <= i.maxTranslate() || f > o.startX && i.translate >= i.minTranslate()) return;
        if (t.activeElement && d.target === t.activeElement && d.target.matches(s.focusableElements)) return s.isMoved = !0, void(i.allowClick = !1);
        ...
        if (s.isScrolling && i.emit("touchMoveOpposite", d), void 0 === s.startMoving && (o.currentX === o.startX && o.currentY === o.startY || (s.startMoving = !0)), s.isScrolling || i.zoom && i.params.zoom && i.params.zoom.enabled && s.evCache.length > 1) return void(s.isTouched = !1);
        ...
        const w = i.params.loop && !r.cssMode,
            E = "next" === i.swipeDirection && i.allowSlideNext || "prev" === i.swipeDirection && i.allowSlidePrev;
        if (!s.isMoved) {
            if (w && E && i.loopFix({
            ...
            s.allowMomentumBounce = !1, !r.grabCursor || !0 !== i.allowSlideNext && !0 !== i.allowSlidePrev || i.setGrabCursor(!0), i.emit("sliderFirstMove", d)
        }
        let _;
        s.isMoved && b !== i.touchesDirection && w && E && Math.abs(v) >= 1 && (i.loopFix({
            direction: i.swipeDirection,
            setTranslate: !0
        }), _ = !0), i.emit("sliderMove", d), s.isMoved = !0, s.currentTranslate = v + s.startTranslate;
        let x = !0,
            S = r.resistanceRatio;
        if (r.touchReleaseOnEdges && (S = 0), v > 0 ? (w && E && !_ && s.currentTranslate > (r.centeredSlides ? i.minTranslate() - i.size / 2 : i.minTranslate()) && i.loopFix({
                direction: "prev",
                setTranslate: !0,
                activeSlideIndex: 0
            }), s.currentTranslate > i.minTranslate() && (x = !1, r.resistance && (s.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + s.startTranslate + v) ** S))) : v < 0 && (w && E && !_ && s.currentTranslate < (r.centeredSlides ? i.maxTranslate() + i.size / 2 : i.maxTranslate()) && i.loopFix({
                direction: "next",
                setTranslate: !0,
                activeSlideIndex: i.slides.length - ("auto" === r.slidesPerView ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
            }), s.currentTranslate < i.maxTranslate() && (x = !1, r.resistance && (s.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - s.startTranslate - v) ** S))), x && (d.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), i.allowSlidePrev || i.allowSlideNext || (s.currentTranslate = s.startTranslate), r.threshold > 0) {
    ...
    function z(e) {
        ...
        if (t.allowClick) {
            ...
            t.updateClickedSlide(e && e[0] || u.target, e), t.emit("tap click", u), f < 300 && p - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", u)
        }
        if (i.lastClickTime = a(), o(() => {
                t.destroyed || (t.allowClick = !0)
            }), !i.isTouched || !i.isMoved || !t.swipeDirection || 0 === r.diff || i.currentTranslate === i.startTranslate) return i.isTouched = !1, i.isMoved = !1, void(i.startMoving = !1);
        let h;
        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, h = s.followFinger ? l ? t.translate : -t.translate : -i.currentTranslate, s.cssMode) return;
    ...
    const R = (e, t) => {
            ...
            r[c]("pointerdown", e.onTouchStart, {
                ...
                passive: !0
            }), (s.preventClicks || s.preventClicksPropagation) && r[c]("click", e.onClick, !0), s.cssMode && o[c]("scroll", e.onScroll), s.updateOnWindowResize ? e[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D, !0) : e[d]("observerUpdate", D, !0), r[c]("load", e.onLoad, {
                capture: !0
            })
        },
    ...
    const $ = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    for (let s = 0; s < f; s += 1) {
                        let r;
                        if (I = 0, p[s] && (r = p[s]), L && e.grid.updateSlide(s, r, f, t), !p[s] || "none" !== v(r, "display")) {
                            if ("auto" === n.slidesPerView) {
                                k && (p[s].style[t("width")] = "");
                                const o = getComputedStyle(r),
                                    a = r.style.transform,
                                    l = r.style.webkitTransform;
                                if (a && (r.style.transform = "none"), l && (r.style.webkitTransform = "none"), n.roundLengths) I = e.isHorizontal() ? E(r, "width", !0) : E(r, "height", !0);
                                else {
                                    const e = i(o, "width"),
                                        t = i(o, "padding-left"),
                                        n = i(o, "padding-right"),
                    ...
                    if (f !== d && e.emit("slidesLengthChange"), m.length !== _ && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), g.length !== x && e.emit("slidesGridLengthChange"), n.watchSlidesProgress && e.updateSlidesOffset(), !(c || n.cssMode || "slide" !== n.effect && "fade" !== n.effect)) {
                        const t = n.containerModifierClass + "backface-hidden",
                            i = e.el.classList.contains(t);
                        f <= n.maxBackfaceHiddenSlides ? i || e.el.classList.add(t) : i && e.el.classList.remove(t)
                    }
                },
                ...
                updateSlidesProgress: function(e) {
                    ...
                    for (let e = 0; e < n.length; e += 1) {
                        ...
                        (p >= 0 && p < t.size - 1 || f > 1 && f <= t.size || p <= 0 && f >= t.size) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), n[e].classList.add(i.slideVisibleClass)), l.progress = s ? -d : d, l.originalProgress = s ? -u : u
                    }
                },
                ...
                updateSlidesClasses: function() {
                    const e = this,
                        ...
                        o = e => h(n, `.${i.slideClass}${e}, swiper-slide${e}`)[0];
                    let a;
                    if (t.forEach(e => {
            ...
            transition: {
                ...
                transitionStart: function(e, t) {
                    ...
                    n.cssMode || (n.autoHeight && i.updateAutoHeight(), A({
                        swiper: i,
                        runCallbacks: e,
                        direction: t,
                        step: "Start"
                ...
                transitionEnd: function(e, t) {
                    ...
                    i.animating = !1, n.cssMode || (i.setTransition(0), A({
                        swiper: i,
                        runCallbacks: e,
                        direction: t,
                        step: "End"
            ...
            slide: {
                slideTo: function(e, t, i, n, s) {
                    ...
                    let b;
                    if (o !== (d || 0) && i && r.emit("beforeSlideChangeStart"), r.updateProgress(y), b = o > u ? "next" : o < u ? "prev" : "reset", f && -y === r.translate || !f && y === r.translate) return r.updateActiveIndex(o), a.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== a.effect && r.setTranslate(y), "reset" !== b && (r.transitionStart(i, b), r.transitionEnd(i, b)), !1;
                    if (a.cssMode) {
                        const e = r.isHorizontal(),
                            i = f ? y : -y;
                        if (0 === t) {
                ...
                slidePrev: function(e, t, i) {
                    ...
                    let m = 0;
                    if (void 0 !== h && (m = o.indexOf(h), m < 0 && (m = n.activeIndex - 1), "auto" === s.slidesPerView && 1 === s.slidesPerGroup && s.slidesPerGroupAuto && (m = m - n.slidesPerViewDynamic("previous", !0) + 1, m = Math.max(m, 0))), s.rewind && n.isBeginning) {
                ...
                slideToClickedSlide: function() {
                    ...
                    if (t.loop) {
                        ...
                        s = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - n / 2 || r > e.slides.length - e.loopedSlides + n / 2 ? (e.loopFix(), r = e.getSlideIndex(h(i, `${a}[data-swiper-slide-index="${s}"]`)[0]), o(() => {
                            e.slideTo(r)
                        })) : e.slideTo(r) : r > e.slides.length - n ? (e.loopFix(), r = e.getSlideIndex(h(i, `${a}[data-swiper-slide-index="${s}"]`)[0]), o(() => {
                            e.slideTo(r)
                        })) : e.slideTo(r)
                    } else e.slideTo(r)
                }
            ...
            loop: {
                loopCreate: function(e) {
                    ...
                    !i.loop || t.virtual && t.params.virtual.enabled || (h(n, `.${i.slideClass}, swiper-slide`).forEach((e, t) => {
                ...
                loopFix: function(e) {
                    ...
                    const g = [],
                        v = [];
                    let y = l.activeIndex;
                    void 0 === r ? r = l.getSlideIndex(l.slides.filter(e => e.classList.contains(f.slideActiveClass))[0]) : y = r;
                    const b = "next" === n || !n,
                        w = "prev" === n || !n;
                    let E = 0,
                        _ = 0;
                    if (r < m) {
                        ...
                        _ = Math.max(r - (l.slides.length - 2 * m), f.slidesPerGroup);
                        for (let e = 0; e < _; e += 1) {
                            const t = e - Math.floor(e / c.length) * c.length;
                            v.push(t)
                        }
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = O.bind(e), e.onTouchMove = P.bind(e), e.onTouchEnd = z.bind(e), i.cssMode && (e.onScroll = H.bind(e)), e.onClick = j.bind(e), e.onLoad = N.bind(e), B || (t.addEventListener("touchstart", W), B = !0), R(e, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    }), u && !m ? e.disable() : !u && m && e.enable(), e.currentBreakpoint = o, e.emit("_beforeBreakpoint", a), i && (f ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !h && g ? (e.loopCreate(t), e.updateSlides()) : h && !g && e.loopDestroy()), e.emit("breakpoint", a)
                },
    ...
    class X {
        constructor() {
            ...
            1 === s.length && s[0].constructor && "Object" === Object.prototype.toString.call(s[0]).slice(8, -1) ? t = s[0] : [e, t] = s, t || (t = {}), t = d({}, t), e && !t.el && (t.el = e);
            const o = n();
            ...
            const c = d({}, F, l);
            return a.params = d({}, c, G, t), a.originalParams = d({}, a.params), a.passedParams = d({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
        ...
        getSlideIndex(e) {
            const {
                slidesEl: t,
                params: i
            } = this, n = y(h(t, `.${i.slideClass}, swiper-slide`)[0]);
            return y(e) - n
        }
        ...
        mount(e) {
            ...
            let s = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(n()) : h(i, n())[0];
            return !s && t.params.createElements && (s = m("div", t.params.wrapperClass), i.append(s), h(i, "." + t.params.slideClass).forEach(e => {
                s.append(e)
            })), Object.assign(t, {
                el: i,
                wrapperEl: s,
    ...
    const re = [function(e) {
        ...
        function d(e) {
            ...
            if (r && g >= b ? (w -= b, s || (_ += i.slidesGrid[0])) : r && g < b && (w = -b, s && (_ += i.slidesGrid[0])), Object.assign(i.virtual, {
                    from: w,
                    to: E,
                    offset: _,
                    ...
                    slidesBefore: b,
                    slidesAfter: y
                }), d === w && u === E && !e) return i.slidesGrid !== f && _ !== m && i.slides.forEach(e => {
        ...
        function p() {
            ...
            if (t.params.loop ? (r = t.previousRealIndex || 0, n = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (n = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, n = t.activeIndex || 0), "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                let l, c, p;
                if (i.dynamicBullets && (o = E(s[0], t.isHorizontal() ? "width" : "height", !0), u.forEach(e => {
                        e.style[t.isHorizontal() ? "width" : "height"] = o * (i.dynamicMainBullets + 4) + "px"
                    }), i.dynamicMainBullets > 1 && void 0 !== r && (a += n - (r || 0), a > i.dynamicMainBullets - 1 ? a = i.dynamicMainBullets - 1 : a < 0 && (a = 0)), l = Math.max(n - a, 0), c = l + (Math.min(s.length, i.dynamicMainBullets) - 1), p = (c + l) / 2), s.forEach(e => {
                    ...
                    const s = y(e);
                    s === n ? e.classList.add(...i.bulletActiveClass.split(" ")) : t.isElement && e.setAttribute("part", "bullet"), i.dynamicBullets && (s >= l && s <= c && e.classList.add(...(i.bulletActiveClass + "-main").split(" ")), s === l && d(e, "prev"), s === c && d(e, "next"))
                });
                else {
                    const e = s[n];
            ...
            u.forEach((e, r) => {
                ...
                "custom" === i.type && i.renderCustom ? (e.innerHTML = i.renderCustom(t, n + 1, f), 0 === r && s("paginationRender", e)) : (0 === r && s("paginationRender", e), s("paginationUpdate", e)), t.params.watchOverflow && t.enabled && e.classList[t.isLocked ? "add" : "remove"](i.lockClass)
            })
        }
        ...
        function v() {
            ...
            let a = c,
                l = (d - c) * o;
            i ? (l = -l, l > 0 ? (a = c - l, l = 0) : -l + c > d && (a = d + l)) : l < 0 ? (a = c + l, l = 0) : l + c > d && (a = d - l), t.isHorizontal() ? (n.style.transform = `translate3d(${l}px, 0, 0)`, n.style.width = a + "px") : (n.style.transform = `translate3d(0px, ${l}px, 0)`, n.style.height = a + "px"), r.hide && (clearTimeout(f), s.style.opacity = 1, f = setTimeout(() => {
        ...
        function y() {
            ...
            i.style.width = "", i.style.height = "", d = t.isHorizontal() ? n.offsetWidth : n.offsetHeight, u = t.size / (t.virtualSize + t.params.slidesOffsetBefore - (t.params.centeredSlides ? t.snapGrid[0] : 0)), c = "auto" === t.params.scrollbar.dragSize ? d * u : parseInt(t.params.scrollbar.dragSize, 10), t.isHorizontal() ? i.style.width = c + "px" : i.style.height = c + "px", n.style.display = u >= 1 ? "none" : "", t.params.scrollbar.hide && (n.style.opacity = 0), t.params.watchOverflow && t.enabled && e.el.classList[t.isLocked ? "add" : "remove"](t.params.scrollbar.lockClass)
        }
        ...
        function w(e) {
            ...
            let r;
            r = (b(e) - g(s)[t.isHorizontal() ? "left" : "top"] - (null !== l ? l : c / 2)) / (d - c), r = Math.max(Math.min(r, 1), 0), n && (r = 1 - r);
        ...
        function E(e) {
            ...
            p = !0, l = e.target === a ? b(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), s.style.transitionDuration = "100ms", a.style.transitionDuration = "100ms", w(e), clearTimeout(h), o.style.transitionDuration = "0ms", i.hide && (o.style.opacity = 1), t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "none"), r("scrollbarDragStart", e)
        }
        ...
        function x(e) {
            ...
            p && (p = !1, t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "", s.style.transitionDuration = ""), i.hide && (clearTimeout(h), h = o(() => {
        ...
        function S(e) {
            ...
            r[c]("pointerdown", E, o), a[c]("pointermove", _, o), a[c]("pointerup", x, l)
        }
        ...
        const s = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
            ...
            o = () => {
                ...
                t.isElement && l.push(...h(t.hostEl, s)), l.forEach(e => {
                    r(e, n)
                }), i.forEach((e, i) => {
                    let a = e.progress;
        ...
        function _(e) {
            if ("mouse" === e.pointerType && p.splice(0, p.length), !E(e)) return;
            ...
            if (a = !1, c = !1, p.push(e), !(p.length < 2)) {
                if (a = !0, f.scaleStart = w(), !f.slideEl) {
                    ...
                    if (n && (n = n.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), f.imageEl = n, f.imageWrapEl = n ? b(f.imageEl, "." + i.containerClass)[0] : void 0, !f.imageWrapEl) return void(f.imageEl = void 0);
        ...
        function x(e) {
            ...
            s >= 0 && (p[s] = e), p.length < 2 || (c = !0, f.scaleMove = w(), f.imageEl && (n.scale = f.scaleMove / f.scaleStart * d, n.scale > f.maxRatio && (n.scale = f.maxRatio - 1 + (n.scale - f.maxRatio + 1) ** .5), n.scale < i.minRatio && (n.scale = i.minRatio + 1 - (i.minRatio - n.scale + 1) ** .5), f.imageEl.style.transform = `translate3d(0,0,0) scale(${n.scale})`))
        }
        ...
        function S(e) {
            ...
            const i = t.params.zoom,
                n = t.zoom,
                s = p.findIndex(t => t.pointerId === e.pointerId);
            s >= 0 && p.splice(s, 1), a && c && (a = !1, c = !1, f.imageEl && (n.scale = Math.max(Math.min(n.scale, f.maxRatio), i.minRatio), f.imageEl.style.transitionDuration = t.params.speed + "ms", f.imageEl.style.transform = `translate3d(0,0,0) scale(${n.scale})`, d = n.scale, u = !1, n.scale > 1 && f.slideEl ? f.slideEl.classList.add("" + i.zoomedSlideClass) : n.scale <= 1 && f.slideEl && f.slideEl.classList.remove("" + i.zoomedSlideClass), 1 === n.scale && (f.originX = 0, f.originY = 0, f.slideEl = void 0)))
        }
        ...
        function T(e) {
            ...
            if (m.minX = Math.min(f.slideWidth / 2 - n / 2, 0), m.maxX = -m.minX, m.minY = Math.min(f.slideHeight / 2 - s / 2, 0), m.maxY = -m.minY, m.touchesCurrent.x = p.length > 0 ? p[0].pageX : e.pageX, m.touchesCurrent.y = p.length > 0 ? p[0].pageY : e.pageY, Math.max(Math.abs(m.touchesCurrent.x - m.touchesStart.x), Math.abs(m.touchesCurrent.y - m.touchesStart.y)) > 5 && (t.allowClick = !1), !m.isMoved && !u) {
        ...
        function L() {
            ...
            if (!f.slideEl) {
                ...
                e && (e = e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), f.imageEl = e, f.imageWrapEl = e ? b(f.imageEl, "." + i.containerClass)[0] : void 0
            }
        ...
        function A() {
            ...
            t.wrapperEl.addEventListener("pointerdown", _, i), t.wrapperEl.addEventListener("pointermove", x, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        function O() {
            ...
            t.wrapperEl.removeEventListener("pointerdown", _, i), t.wrapperEl.removeEventListener("pointermove", x, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        const b = (e, t, i) => {
                a(e), "BUTTON" !== e.tagName && (c(e, "button"), e.addEventListener("keydown", h)), u(e, i),
                    function(e, t) {
                        (e = o(e)).forEach(e => {
        ...
        n("beforeInit", () => {
            ...
            t.params.a11y.enabled && (() => {
                ...
                p = o(p), f = o(f), p && p.forEach(t => b(t, r, e.nextSlideMessage)), f && f.forEach(t => b(t, r, e.prevSlideMessage)), v() && (Array.isArray(t.pagination.el) ? t.pagination.el : [t.pagination.el]).forEach(e => {
                    e.addEventListener("keydown", h)
                }), t.el.addEventListener("focus", _, !0), t.el.addEventListener("pointerdown", w, !0), t.el.addEventListener("pointerup", E, !0)
            })()
            ...
            t.params.a11y.enabled && function() {
                ...
                i && (t.isBeginning ? (p(i), l(i)) : (f(i), a(i))), e && (t.isEnd ? (p(e), l(e)) : (f(e), a(e)))
            }()
        }), n("paginationUpdate", () => {
            t.params.a11y.enabled && function() {
                const e = t.params.a11y;
                g() && t.pagination.bullets.forEach(i => {
                    t.params.pagination.clickable && (a(i), t.params.pagination.renderBullet || (c(i, "button"), u(i, e.paginationBulletMessage.replace(/\{\{index\}\}/, y(i) + 1)))), i.matches(U(t.params.pagination.bulletActiveClass)) ? i.setAttribute("aria-current", "true") : i.removeAttribute("aria-current")
                })
            }()
        }), n("destroy", () => {
            t.params.a11y.enabled && function() {
                ...
                e = o(e), i = o(i), e && e.forEach(e => e.removeEventListener("keydown", h)), i && i.forEach(e => e.removeEventListener("keydown", h)), v() && (Array.isArray(t.pagination.el) ? t.pagination.el : [t.pagination.el]).forEach(e => {
                    e.removeEventListener("keydown", h)
                }), t.el.removeEventListener("focus", _, !0), t.el.removeEventListener("pointerdown", w, !0), t.el.removeEventListener("pointerup", E, !0)
            }()
        })
    }, function(e) {
        let {
        ...
        const a = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
            l = e => {
                ...
                const n = i.pathname.slice(1).split("https://html.onertheme.com/").filter(e => "" !== e),
                    s = n.length;
                return {
                    key: n[s - 2],
                    value: n[s - 1]
        ...
        let c, d, u, p, f, h, m, g = l && l.autoplay ? l.autoplay.delay : 3e3,
        ...
        const w = () => {
            ...
            E = e => {
                ...
                !Number.isNaN(r) && r > 0 && void 0 === e && (n = r, g = r, v = r), c = n;
            ...
            S = (e, i) => {
                ...
                c = r - ((new Date).getTime() - y), s.isEnd && c < 0 && !s.params.loop || (c < 0 && (c = 0), n())
            },
            T = () => {
                s.isEnd && c < 0 && !s.params.loop || s.destroyed || !s.autoplay.running || (y = (new Date).getTime(), m ? (m = !1, E(c)) : E(), s.autoplay.paused = !1, a("autoplayResume"))
            },
            C = () => {
                if (s.destroyed || !s.autoplay.running) return;
                const e = n();
        ...
        o("init", () => {
            s.params.autoplay.enabled && (s.params.autoplay.pauseOnMouseEnter && (s.el.addEventListener("pointerenter", M), s.el.addEventListener("pointerleave", L)), n().addEventListener("visibilitychange", C), y = (new Date).getTime(), _())
        }), o("destroy", () => {
            ...
            !s.destroyed && s.autoplay.running && (s.params.autoplay.disableOnInteraction ? x() : (u = !0, p = !1, m = !1, f = setTimeout(() => {
                m = !0, p = !0, S(!0)
            }, 200)))
        }), o("touchEnd", () => {
        ...
        function d(e) {
            ...
            if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (s = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (s = 1), s = Math.floor(s), i.slides.forEach(e => e.classList.remove(r)), i.params.loop || i.params.virtual && i.params.virtual.enabled)
                for (let e = 0; e < s; e += 1) h(i.slidesEl, `[data-swiper-slide-index="${t.realIndex+e}"]`).forEach(e => {
                    e.classList.add(r)
                });
            else
                    ...
                    const i = n(),
                        s = () => {
                            ...
                            if (n && n.swiper) e.swiper = n.swiper, l(), d(!0);
                                ...
                                const i = s => {
                                    e.swiper = s.detail[0], n.removeEventListener("init", i), l(), d(!0), e.swiper.update(), t.update()
                                };
                ...
                onTouchEnd: function(e) {
                    ...
                    if (i < -t.minTranslate()) t.slideTo(t.activeIndex);
                        ...
                        if (r.freeMode.momentum) {
                            ...
                            r.freeMode.momentumBounce && f ? (t.updateProgress(p), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating = !0, w(o, () => {
        ...
        a("init", () => {
            ...
            updateSlide: (e, s, o, a) => {
                ...
                if ("row" === p && c > 1) {
                    ...
                    m = Math.floor(n / r), h = n - m * r + i * c, f = h + m * t / u, s.style.order = f
                } else "column" === p ? (h = Math.floor(e / u), m = e - h * u, (h > n || h === n && m === u - 1) && (m += 1, m >= u && (m = 0, h += 1))) : (m = Math.floor(e / i), h = e - m * i);
                s.row = m, s.column = h, s.style[a("margin-top")] = 0 !== m ? d && d + "px" : ""
            },
            updateWrapperSize: (e, i, n) => {
                ...
                if (r.virtualSize = (e + a) * t, r.virtualSize = Math.ceil(r.virtualSize / c) - a, r.wrapperEl.style[n("width")] = r.virtualSize + a + "px", s) {
                    const e = [];
        ...
        te({
            ...
            setTranslate: () => {
                ...
                let f, h = 0;
                d.shadow && (u ? (f = t.wrapperEl.querySelector(".swiper-cube-shadow"), f || (f = m("div", "swiper-cube-shadow"), t.wrapperEl.append(f)), f.style.height = r + "px") : (f = e.querySelector(".swiper-cube-shadow"), f || (f = m("div", "swiper-cube-shadow"), e.append(f))));
                for (let e = 0; e < n.length; e += 1) {
                    const t = n[e];
                    let i = e;
                    ...
                    let f = 0,
                        m = 0,
                        g = 0;
                    i % 4 == 0 ? (f = 4 * -o * l, g = 0) : (i - 1) % 4 == 0 ? (f = 0, g = 4 * -o * l) : (i - 2) % 4 == 0 ? (f = l + 4 * o * l, g = l) : (i - 3) % 4 == 0 && (f = -l, g = 3 * l + 4 * l * o), a && (f = -f), u || (m = f, f = 0);
                    const v = `rotateX(${u?0:-r}deg) rotateY(${u?r:0}deg) translate3d(${f}px, ${m}px, ${g}px)`;
                    c <= 1 && c > -1 && (h = 90 * i + 90 * c, a && (h = 90 * -i - 90 * c)), t.style.transform = v, d.slideShadows && s(t, c, u)
                }
                if (i.style.transformOrigin = `50% 50% -${l/2}px`, i.style["-webkit-transform-origin"] = `50% 50% -${l/2}px`, d.shadow)
                    if (u) f.style.transform = `translate3d(0px, ${r/2+d.shadowOffset}px, ${-r/2}px) rotateX(90deg) rotateZ(0deg) scale(${d.shadowScale})`;
                    else {
                        const e = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                            ...
                            n = d.shadowScale / t,
                            s = d.shadowOffset;
                        f.style.transform = `scale3d(${i}, 1, ${n}) translate3d(0px, ${o/2+s}px, ${-o/2/n}px) rotateX(-90deg)`
                    } const g = (c.isSafari || c.isWebView) && c.needPerspectiveFix ? -l / 2 : 0;
                i.style.transform = `translate3d(0px,0,${g}px) rotateX(${t.isHorizontal()?0:h}deg) rotateY(${t.isHorizontal()?-h:0}deg)`, i.style.setProperty("--swiper-cube-translate-z", g + "px")
            },
            setTransition: e => {
                const {
                    el: i,
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < e.length; r += 1) {
                    ...
                    let c = -180 * a,
                        ...
                        p = 0;
                    t.isHorizontal() ? i && (c = -c) : (p = u, u = 0, d = -c, c = 0), o.style.zIndex = -Math.abs(Math.round(a)) + e.length, n.slideShadows && s(o, a);
        ...
        i({
            ...
            setTranslate: () => {
                const {
                    ...
                    slides: n,
                    slidesSizesGrid: s
                } = t, r = t.params.coverflowEffect, o = t.isHorizontal(), a = t.translate, l = o ? e / 2 - a : i / 2 - a, c = o ? r.rotate : -r.rotate, d = r.depth;
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < e.length; i += 1) {
                    ...
                    c < 0 ? (m = r.next, h = !0) : c > 0 && (m = r.prev, h = !0), p.forEach((e, t) => {
                        p[t] = `calc(${e}px + (${s(m.translate[t])} * ${Math.abs(c*o)}))`
                    }), f.forEach((e, t) => {
            ...
            setTranslate: () => {
                ...
                for (let l = 0; l < e.length; l += 1) {
                    ...
                    if (s.slideShadows) {
                        ...
                        e || (e = se("cards", c)), e && (e.style.opacity = Math.min(Math.max((Math.abs(u) - .5) / .5, 0), 1))
                    }
                    c.style.zIndex = -Math.abs(Math.round(d)) + e.length, ie(0, c).style.transform = x
                }
            },
            setTransition: e => {
                const i = t.slides.map(e => f(e));
